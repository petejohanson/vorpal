...
class CommandInstance {
  ...
  log() {
    ...
    if (this.downstream) {
      ...
      // TODO: Handle the before function
      // const before = this.downstream.commandObject._before;
      // if (_.isFunction(before)) {
      //   try {
      //     before.call(this.downstream, this.downstream.args);
      //   } catch (e) {
    ...
    // TODO: Put an option on command to prevent logs
    // Print logs to screen always
