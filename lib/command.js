...
command.option = function (flags, description, validation, defaults, autocomplete) {
  var self = this;
  var option = new Option(flags, description, validation, defaults, autocomplete);
 ...
 * that in case of rejecton will prevent
